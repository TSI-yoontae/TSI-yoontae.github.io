    ...
    <section className="space-y-5">
        ...
        <section className="tsi-section">
            ...
            <p className="mt-1 text-sm leading-5 text-[#404958]">
                ...
                programming skills. Demonstrated excellence or active
                participation in data-science competitions such as Dacon or
                Kaggle is highly valued. Achievements from the majority of
                domestic competitions and awards in South Korea are not
                considered.
            </p>
            ...
            <div className="mt-3 border border-[#b99a4b] bg-[#f1e7cf] p-3">
                ...
                <div className="mt-2 space-y-2 text-sm leading-5 text-[#4b3a1b]">
                    <p>
                        <strong>Financial Support:</strong> Students who join
                        without prior contact will receive degree supervision
                        but are generally ineligible for lab-funded financial
                        support.
                    </p>

                    <p>
                        <strong>M.S. Graduation:</strong> Graduation may be
                        extended beyond four semesters if the thesis does not
                        meet the advisor&apos;s standards.
                    </p>
                    ...
                    <p>
                        <strong>Continued Lab Membership:</strong> Joining the
                        lab does not guarantee continued supervision. Students
                        are expected to demonstrate sustained initiative,
                        ownership, and commitment to research. A student who
                        shows insufficient research motivation or consistently
                        fails to engage seriously in research may be required to
                        find another advisor immediately, without prior warning.
                    </p>
                </div>
            </div>
            ...
            <div className="mt-3 border border-[#b45a4a] bg-[#f4ded8] p-3">
                <h4 className="text-sm font-extrabold text-[#87382c]">
                    Current Status: All Regular Recruitment Closed
                </h4>

                <p className="mt-1 text-sm leading-5 text-[#404958]">
                    Recruitment for the{' '}
                    <span className="font-bold text-[#87382c]">
