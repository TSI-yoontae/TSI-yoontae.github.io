...
window.HomeTabContent = () => {
    const selectedPapers = [
        ...
        { title: "[ICAIF'24] SimStock : Representation Model for Stock Similarities", links: [{ text: "paper", href: "https://dl.acm.org/doi/abs/10.1145/3604237.3626888" }, { text: "code", href: "https://github.com/Yoontae6719/SimStock-Representation-Model-for-Stock-Similarities" }] },
        ...
        <div className="space-y-12">
            <section>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mt-3">
                   <li><b>[May 2026]</b> Yoontae Hwang Recognized as 'Gold Reviewer(Top Reviewers)' for ICML'26 </li>
