...
const NewsSection = () => {
    const news = [
        ...
        { date: 'Jun 2026', text: "One paper accepted to Journal of Applied Physics." },
        { date: 'May 2026', text: "Yoontae Hwang recognized as a Gold Reviewer (Top Reviewer) for ICML'26." },
        { date: 'May 2026', text: "Two Financial AI papers accepted to ICML'26 (Top Tier AI Confernece; CORE A*)." },
